...
class zes_ras_error_category_exp_v(IntEnum):
    ...
    CACHE_ERRORS = 5                                                        ## The number of errors that have occurred in caches (L1/L3/register
                                                                            ## file/shared local memory/sampler).
    DISPLAY_ERRORS = 6                                                      ## The number of errors that have occurred in the display.
    MEMORY_ERRORS = 7                                                       ## The number of errors that have occurred in Memory Subsystem.
    ...
    PCIE_ERRORS = 10                                                        ## The number of errors that have occurred in the PCIe subsystem
    FABRIC_ERRORS = 11                                                      ## The number of errors that have occurred in the Fabric interconnect in
                                                                            ## the SOC
    SOC_INTERNAL_ERRORS = 12                                                ## The number of errors that have occurred in the SOC internal components
...
class zes_ras_state_exp2_t(Structure):
    _fields_ = [
        ("stype", zes_structure_type_t),                                ## [in] type of this structure
        ("pNext", c_void_p),                                            ## [in][optional] must be null or a pointer to an extension-specific
                                                                        ## structure (i.e. contains stype and pNext).
        ("errorCounter", c_ulonglong)                                   ## [out] Current value of RAS counter for the corresponding error
                                                                        ## category.
    ]

###############################################################################
## @brief RAS error configuration for per-category threshold management
class zes_ras_config_exp_t(Structure):
    _fields_ = [
        ("stype", zes_structure_type_t),                                ## [in] type of this structure
        ("pNext", c_void_p),                                            ## [in][optional] must be null or a pointer to an extension-specific
                                                                        ## structure (i.e. contains stype and pNext).
        ("category", zes_ras_error_category_exp_t),                     ## [in] RAS error category for which threshold is being configured.
        ("threshold", c_ulonglong)                                      ## [in,out] Error count threshold to trigger RAS events. A value of 0
...
if __use_win_types:
    _zesPowerGetUsage_t = WINFUNCTYPE( ze_result_t, zes_pwr_handle_t, POINTER(c_ulong), POINTER(c_ulong) )
else:
    _zesPowerGetUsage_t = CFUNCTYPE( ze_result_t, zes_pwr_handle_t, POINTER(c_ulong), POINTER(c_ulong) )

###############################################################################
## @brief Function-pointer for zesPowerGetLimitsExt2
if __use_win_types:
    _zesPowerGetLimitsExt2_t = WINFUNCTYPE( ze_result_t, zes_pwr_handle_t, POINTER(c_ulong) )
else:
    _zesPowerGetLimitsExt2_t = CFUNCTYPE( ze_result_t, zes_pwr_handle_t, POINTER(c_ulong) )

###############################################################################
## @brief Function-pointer for zesPowerSetLimitsExt2
if __use_win_types:
    _zesPowerSetLimitsExt2_t = WINFUNCTYPE( ze_result_t, zes_pwr_handle_t, c_ulong )
else:
    _zesPowerSetLimitsExt2_t = CFUNCTYPE( ze_result_t, zes_pwr_handle_t, c_ulong )
...
class _zes_power_dditable_t(Structure):
    _fields_ = [
        ...
        ("pfnGetLimitsExt2", c_void_p),                                 ## _zesPowerGetLimitsExt2_t
        ("pfnSetLimitsExt2", c_void_p)                                  ## _zesPowerSetLimitsExt2_t
    ]
...
if __use_win_types:
    _zesRasGetSupportedCategoriesExp_t = WINFUNCTYPE( ze_result_t, zes_ras_handle_t, POINTER(c_ulong), POINTER(zes_ras_error_category_exp_t) )
else:
    _zesRasGetSupportedCategoriesExp_t = CFUNCTYPE( ze_result_t, zes_ras_handle_t, POINTER(c_ulong), POINTER(zes_ras_error_category_exp_t) )

###############################################################################
## @brief Function-pointer for zesRasGetStateExp2
if __use_win_types:
    _zesRasGetStateExp2_t = WINFUNCTYPE( ze_result_t, zes_ras_handle_t, c_ulong, POINTER(zes_ras_error_category_exp_t), POINTER(zes_ras_state_exp2_t) )
else:
    _zesRasGetStateExp2_t = CFUNCTYPE( ze_result_t, zes_ras_handle_t, c_ulong, POINTER(zes_ras_error_category_exp_t), POINTER(zes_ras_state_exp2_t) )

###############################################################################
## @brief Function-pointer for zesRasGetConfigExp
if __use_win_types:
    _zesRasGetConfigExp_t = WINFUNCTYPE( ze_result_t, zes_ras_handle_t, c_ulong, POINTER(zes_ras_config_exp_t) )
else:
    _zesRasGetConfigExp_t = CFUNCTYPE( ze_result_t, zes_ras_handle_t, c_ulong, POINTER(zes_ras_config_exp_t) )

###############################################################################
## @brief Function-pointer for zesRasSetConfigExp
if __use_win_types:
    _zesRasSetConfigExp_t = WINFUNCTYPE( ze_result_t, zes_ras_handle_t, c_ulong, POINTER(zes_ras_config_exp_t) )
else:
    _zesRasSetConfigExp_t = CFUNCTYPE( ze_result_t, zes_ras_handle_t, c_ulong, POINTER(zes_ras_config_exp_t) )
...
class _zes_ras_exp_dditable_t(Structure):
    _fields_ = [
        ...
        ("pfnGetSupportedCategoriesExp", c_void_p),                     ## _zesRasGetSupportedCategoriesExp_t
        ("pfnGetStateExp2", c_void_p),                                  ## _zesRasGetStateExp2_t
        ("pfnGetConfigExp", c_void_p),                                  ## _zesRasGetConfigExp_t
        ("pfnSetConfigExp", c_void_p)                                   ## _zesRasSetConfigExp_t
    ]
...
class ZES_DDI:
    def __init__(self, version : ze_api_version_t):
        ...
        self.zesPowerGetUsage = _zesPowerGetUsage_t(self.__dditable.Power.pfnGetUsage)
        self.zesPowerGetLimitsExt2 = _zesPowerGetLimitsExt2_t(self.__dditable.Power.pfnGetLimitsExt2)
        self.zesPowerSetLimitsExt2 = _zesPowerSetLimitsExt2_t(self.__dditable.Power.pfnSetLimitsExt2)
        ...
        self.zesRasGetSupportedCategoriesExp = _zesRasGetSupportedCategoriesExp_t(self.__dditable.RasExp.pfnGetSupportedCategoriesExp)
        self.zesRasGetStateExp2 = _zesRasGetStateExp2_t(self.__dditable.RasExp.pfnGetStateExp2)
        self.zesRasGetConfigExp = _zesRasGetConfigExp_t(self.__dditable.RasExp.pfnGetConfigExp)
        self.zesRasSetConfigExp = _zesRasSetConfigExp_t(self.__dditable.RasExp.pfnSetConfigExp)
